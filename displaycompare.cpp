...
public:
    ...
    bool deleteSameValue(int value) {
        ...
        if (deleted) {
            cout << "Deleted all duplication of " << value << " from the list." << endl;
            return true;
        } else {
    ...
    void compareHeadAndTail() {
        ...
        if (head->data == tail->data) {
            cout << "Head and Tail values are the same." << endl;
        } else if (head->data > tail->data) {
            cout << "Head value is greater than Tail value." << endl;
        } else {
            cout << "Head value is less than Tail value." << endl;
        }
    }
    ...
    while (true) {
        ...
        switch (choiceChar) {
            ...
            case 'a':
                ...
                cout << "D. Display Head to Tail" << endl;
                cout << "E. Compare Head and Tail" << endl;
                cout << "Enter your choice: ";
                char subChoiceChar;
                cin >> subChoiceChar;
                ...
                switch (subChoiceChar) {
                    ...
                    case 'E':
                    case 'e':
                        list.compareHeadAndTail();
                        break;
                    default:
                        cout << "Invalid sub-choice. Try again." << endl;
                        break;
                }
                break;
            case 'B':
            case 'b':
                ...
                cout << "D. Delete all Duplication" << endl;
                cout << "E. Display Head To Tail" << endl;
                cout << "Enter your choice: ";
                cin >> subChoiceChar;
